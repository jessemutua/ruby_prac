def solution(n)
    ...
    #A variable that holds the maximum number of consecuttive 0's
    ...
    binary.each_char do |char|
        ...
        if char == '0'
            ...
            current_consecutive_zeros = 0 
            # set the gap is true since there exixts another character other than 0 after the first gap
            has_gap = true   
        end
    end 
    #return 0 if theres no other charachter after 0 else return max_consecutive_zeros
